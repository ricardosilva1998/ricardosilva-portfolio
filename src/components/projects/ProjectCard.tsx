...
export function ProjectCard({
  ...
  return (
    ...
    >
      ...
      {project.description && (
        <p className="text-xs text-[var(--color-phosphor-dim)]/90 leading-relaxed">
          {project.description}
        </p>
      )}
      ...
      <footer className="mt-auto flex flex-wrap items-center gap-2 pt-2 text-xs">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-1.5 rounded-sm border border-[var(--color-phosphor-dim)] px-2 py-1 text-[var(--color-phosphor)] transition hover:bg-[var(--color-phosphor)] hover:text-[var(--color-bg)] phosphor-glow-soft"
        >
        ...
        {project.liveUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 rounded-sm border border-[var(--color-amber)] px-2 py-1 text-[var(--color-amber)] transition hover:bg-[var(--color-amber)] hover:text-[var(--color-bg)]"
          >
